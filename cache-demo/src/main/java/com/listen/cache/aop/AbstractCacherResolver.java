 ...
 * @since 4.1
 */
public abstract class AbstractCacherResolver implements CacherResolver, InitializingBean {

	private CacheManager cacheManager;


	protected AbstractCacherResolver() {
	}

	protected AbstractCacherResolver(CacheManager cacheManager) {
